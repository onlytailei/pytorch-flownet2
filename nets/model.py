...
class FlowNetC(Model):
    ...
    def __init__(self, args):
        ...
        self.conv1_a = nn.Conv2d(6, 64, 7, stride=2. padding=3)
        self.conv1_b = nn.Conv2d(6, 64, 7, stride=2. padding=3)
        self.conv2_a = nn.Conv2d(6, 64, 7, stride=2. padding=3)
        self.conv2_b = nn.Conv2d(6, 64, 7, stride=2. padding=3)
        self.conv3_a = nn.Conv2d(6, 64, 7, stride=2. padding=3)
        self.conv3_a = nn.Conv2d(6, 64, 7, stride=2. padding=3)
